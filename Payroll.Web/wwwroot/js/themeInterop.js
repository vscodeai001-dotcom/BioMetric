...
window.attendanceRefresh = (function () {
    ...
    async function start() {
        ...
        if (!window.signalR) {
            ...
            console.warn(
                "SignalR client is not available."
            );
            ...
            async function (data) {
                ...
                for (const listener of listeners) {
                    ...
                    try {
                        ...
                        console.warn(
                            "Regularization listener failed:",
                            error
                        );
                    }
                }
        ...
        try {
            ...
            console.log(
                "Live attendance refresh connected."
            );
